...
<div
    ...
    {{
        $attributes->class([
            'fi-global-search-results-ctn absolute inset-x-4 z-10 mt-2 max-h-96 overflow-auto rounded-lg bg-white ring-1 shadow-lg ring-gray-950/5 transition sm:inset-x-auto sm:end-0 sm:w-screen sm:max-w-sm dark:bg-gray-900 dark:ring-white/10',
