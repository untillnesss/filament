<div class="flex flex-col gap-3 text-sm">
            ...
            <li>
                <button
                    ...
                    x-on:click="
                        ...
                        $tooltip(@js(__('filament-panels::auth/multi-factor/recovery-codes-modal-content.messages.copied')), {
                            theme: $store.theme,
                        })
                    "
                >
    ...
    <p>
        ...
        <x-filament::link
            ...
            "
        >
            {{ __('filament-panels::auth/multi-factor/recovery-codes-modal-content.actions.copy.label') }}
        </x-filament::link>
        ...
        <x-filament::link
            ...
            download
        >
            {{ __('filament-panels::auth/multi-factor/recovery-codes-modal-content.actions.download.label') }}
        </x-filament::link>
